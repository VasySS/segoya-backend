...
var (
	...
	// ErrOnlyCreatorCanUpdateSettings is returned when the user tries to update
	// settings of the lobby that was not created by them.
	ErrOnlyCreatorCanUpdateSettings = errors.New("only creator can update settings")

...
func (_m *PanoramaUsecase) GetStreetview(ctx context.Context, provider game.PanoramaProvider, id uuid.UUID) (game.PanoramaMetadata, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, game.PanoramaProvider, uuid.UUID) (game.PanoramaMetadata, error)); ok {
		return rf(ctx, provider, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, game.PanoramaProvider, uuid.UUID) game.PanoramaMetadata); ok {
		r0 = rf(ctx, provider, id)
	} else {
		r0 = ret.Get(0).(game.PanoramaMetadata)
	}

	if rf, ok := ret.Get(1).(func(context.Context, game.PanoramaProvider, uuid.UUID) error); ok {

...
func (_m *Repository) GetSingleplayerGame(ctx context.Context, gameID uuid.UUID) (gamesingleplayer.Game, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (gamesingleplayer.Game, error)); ok {
		return rf(ctx, gameID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) gamesingleplayer.Game); ok {
		r0 = rf(ctx, gameID)
	} else {
...
func (_m *Repository) GetSingleplayerGameGuesses(ctx context.Context, gameID uuid.UUID) ([]gamesingleplayer.Guess, error) {
	ret := _m.Called(ctx, gameID)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]gamesingleplayer.Guess, error)); ok {
		return rf(ctx, gameID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) []gamesingleplayer.Guess); ok {
		r0 = rf(ctx, gameID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Repository) GetSingleplayerRound(ctx context.Context, gameID uuid.UUID, roundNum int) (gamesingleplayer.Round, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int) (gamesingleplayer.Round, error)); ok {
		return rf(ctx, gameID, roundNum)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int) gamesingleplayer.Round); ok {
...
func (_m *Repository) LockSingleplayerGame(ctx context.Context, gameID uuid.UUID) error {
	ret := _m.Called(ctx, gameID)
...
func (_m *Repository) NewSingleplayerGame(ctx context.Context, req dto.NewSingleplayerGameRequest) (uuid.UUID, error) {
	ret := _m.Called(ctx, req)
	...
	var r0 uuid.UUID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.NewSingleplayerGameRequest) (uuid.UUID, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, dto.NewSingleplayerGameRequest) uuid.UUID); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {

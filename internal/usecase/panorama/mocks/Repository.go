...
func (_m *Repository) GetGoogleStreetview(ctx context.Context, id int) (game.GoogleStreetview, error) {
...
func (_m *Repository) GetSeznamStreetview(ctx context.Context, id int) (game.SeznamStreetview, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetYandexAirview(ctx context.Context, id int) (game.YandexAirview, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetYandexStreetview(ctx context.Context, id int) (game.YandexStreetview, error) {
	ret := _m.Called(ctx, id)

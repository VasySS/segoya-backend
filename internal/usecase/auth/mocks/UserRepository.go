...
func (_m *UserRepository) GetOAuth(ctx context.Context, userID uuid.UUID) ([]user.OAuth, error) {
	...
	var r0 []user.OAuth
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]user.OAuth, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) []user.OAuth); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {

...
func (_m *SessionRepository) DeleteSession(ctx context.Context, userID uuid.UUID, sessionID uuid.UUID) error {
...
func (_m *SessionRepository) GetOAuthUserID(ctx context.Context, state string) (uuid.UUID, error) {
...
func (_m *SessionRepository) GetSession(ctx context.Context, userID uuid.UUID, sessionID uuid.UUID) (user.Session, error) {
	ret := _m.Called(ctx, userID, sessionID)
	...
	var r0 user.Session
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) (user.Session, error)); ok {
		return rf(ctx, userID, sessionID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) user.Session); ok {
		r0 = rf(ctx, userID, sessionID)
	} else {
...
func (_m *SessionRepository) GetSessions(ctx context.Context, userID uuid.UUID) ([]user.Session, error) {
	...
	var r0 []user.Session
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) ([]user.Session, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) []user.Session); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]user.Session)

...
func decodeEndMultiplayerGameResponse(resp *http.Response) (res EndMultiplayerGameRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response EndMultiplayerGameOKApplicationJSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/problem+json":
			...
			var response EndMultiplayerGameBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case ct == "application/problem+json":
			...
			var response EndMultiplayerGameUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/problem+json":
			...
			var response EndMultiplayerGameInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetHealthResponse(resp *http.Response) (res *GetHealthOK, _ error) {
	...
	case 200:
		...
		switch {
		case ct == "application/vnd.health+json":
			buf, err := io.ReadAll(resp.Body)
			if err != nil {
				return res, err
			}

...
func encodeEndMultiplayerGameResponse(response EndMultiplayerGameRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *EndMultiplayerGameOKApplicationJSON:
	...
	case *EndMultiplayerGameBadRequest:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *EndMultiplayerGameUnauthorized:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
	...
	case *EndMultiplayerGameInternalServerError:
		w.Header().Set("Content-Type", "application/problem+json")
		w.WriteHeader(500)
		span.SetStatus(codes.Error, http.StatusText(500))
